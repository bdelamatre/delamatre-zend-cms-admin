...
use DelamatreZendCmsAdmin\Form\Element\Document;
use Zend\Form\Form;

class SelectDocument extends Form{
    ...
    public function __construct($name=null,$options=array()){
        ...
        $owner = new Document('document',array('exclude'=>$exclude),$this->getEntityManager());
