...
class CaseStudy extends Select{
    ...
    public function __construct($name=null, $options=array(), EntityManager $entityManager){
        ...
        $qb->select('t')->from('DelamatreZendCms\Entity\CaseStudy','t')->orderBy('t.title','ASC');
        ...
        foreach($technologies as $technology){
            $valueOptions[$technology['id']] = $technology['title'] .' ('.$technology['location'].')';
        }

        $this->setValueOptions($valueOptions);
        $this->setLabel('Case Study');
